...
class OperationsRestAsyncTransport(OperationsTransport):
    """REST Async backend transport for Operations.
    ...
    def __init__(
        ...
        *,
        ...
        #TODO Add support for default_host
        self._session = AsyncAuthorizedSession(
            self._credentials
        )
        # TODO REMOVE MTLS CODE
    ...
    async def _get_operation(
        ...
        *,
        ...
        json_format.Parse(await response.read(), api_response, ignore_unknown_fields=False)
        return api_response
