...
from google.auth.transport._aiohttp_requests import AuthorizedSession  # type: ignore
...
class OperationsRestAsyncIOTransport(OperationsTransport):
    ...
    async def _list_operations(
        ...
        *,
        ...
        if response.status >= 400:
            raise await core_exceptions.from_http_response_async(response)
